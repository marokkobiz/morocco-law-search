...
class LawsSpider(scrapy.Spider):
    ...
    def is_blacklisted(self, title: str, url: str) -> bool:
        ...
        blacklist_keywords = [
            ...
            "lettre royale", "lettres royales", "allocution","Lire"
            # Arabic
            "الرسالتان الملكيتان"
            "إقرأ الآن", "خطاب ملكي", "خطابات ملكية", "رسالة ملكية", "رسائل ملكية","الرسالة", "الخطاب الملكي", "كلمة صاحب الجلالة", "رسالة صاحب الجلالة", "كلمة جلالة الملك", "رسالة جلالة الملك",
            "خطاب", "الخطب الملكية", "رسالة ملكية", "الرسائل الملكية", "رسائل ملكية",
            "خطب جلالة","كلمة صاحب","رسالة صاحب","كلمة صاحب " "رسالة جلالة","الرسالة الملكية","خطاب صاحب الجلالة الملك ","الكلمة الملكية ","رسالة صاحب جلالة " ,"الرسالة السامية", "الخطاب السامي"
        ]
