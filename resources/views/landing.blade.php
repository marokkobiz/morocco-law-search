...
@section('content')
    ...
    <div class="relative z-10 container-page pt-20 md:pt-24 pb-16 md:pb-24">
      <div class="max-w-4xl">
        ...
        <h1 class="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-serif font-bold leading-none tracking-tight">
          <span class="gradient-text">Moroccan Legal<br>Research Engine</span>
        </h1>
        ...
        <form class="flex items-center gap-2 p-2 mt-8 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl shadow-blue-500/10 max-w-2xl" action="/login" method="get">
          <div class="flex items-center gap-3 flex-1 px-4">
            ...
            <input type="search" name="q" placeholder="Search article, code, bulletin, or legal issue..." class="w-full bg-transparent border-none text-white placeholder:text-blue-200/50 text-sm md:text-base font-medium focus:outline-none">
          </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12" data-animate="fade-up">
          <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4" style="--delay: 0s">
            <strong class="block text-2xl font-bold text-white">50,000+</strong>
            <span class="block mt-1 text-xs font-semibold tracking-wide text-blue-200/70 uppercase">Documents Indexed</span>
          </div>
          <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4" style="--delay: 0.1s">
            <strong class="block text-2xl font-bold text-white">500+</strong>
            <span class="block mt-1 text-xs font-semibold tracking-wide text-blue-200/70 uppercase">Legal Sources</span>
          </div>
          <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4" style="--delay: 0.2s">
            ...
            <span class="block mt-1 text-xs font-semibold tracking-wide text-blue-200/70 uppercase">Platform Uptime</span>
          </div>
          <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4" style="--delay: 0.3s">
            ...
            <span class="block mt-1 text-xs font-semibold tracking-wide text-blue-200/70 uppercase">Daily Updates</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="sources" class="py-20 md:py-28">
    <div class="container-page" data-animate="fade-up">
      <div class="max-w-3xl">
        ...
        <h2 class="section-title mt-4">Official materials stay visible.</h2>
        <p class="section-desc">Every result includes source metadata, publication dates, and direct links to official documents.</p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-12">
        <article class="card card-hover p-6 md:p-8" data-animate="fade-up" style="--delay: 0s">
          ...
          <h3 class="text-xl font-bold text-gray-900">Official Bulletins</h3>
          <p class="mt-3 text-gray-600 leading-relaxed">Publication metadata, dates, source URLs and indexed document versions from the Official Bulletin.</p>
        </article>
        ...
        <article class="card card-hover p-6 md:p-8" data-animate="fade-up" style="--delay: 0.1s">
          ...
          <h3 class="text-xl font-bold text-gray-900">Legal Texts</h3>
          <p class="mt-3 text-gray-600 leading-relaxed">Codes, dahirs, decrees, orders and article-level references with version tracking.</p>
        </article>
        ...
        <article class="card card-hover p-6 md:p-8" data-animate="fade-up" style="--delay: 0.2s">
          ...
          <h3 class="text-xl font-bold text-gray-900">Citations</h3>
          <p class="mt-3 text-gray-600 leading-relaxed">Results include source links, article references, and official document identifiers.</p>
        </article>
      </div>
    </div>
  </section>
    ...
    <div class="container-page">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div data-animate="fade-up">
          ...
          <h2 class="section-title mt-4">Built for trust, not overclaiming.</h2>
          <p class="section-desc">Coverage depends on indexed official sources. The platform communicates available sources transparently, not all Moroccan laws.</p>
        </div>
        ...
        <div class="card p-6 md:p-8 border-blue-100 bg-gradient-to-br from-blue-50/50 to-white" data-animate="fade-up" style="--delay: 0.15s">
          <div class="space-y-5">
            <div class="flex items-start gap-4">
              ...
              <div>
                <strong class="block text-gray-900 font-bold">Indexed corpus</strong>
                <span class="text-sm text-gray-600 mt-1 block">Active versions are preferred and clearly labeled</span>
              </div>
            </div>
            <div class="flex items-start gap-4">
              <div class="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <div>
                <strong class="block text-gray-900 font-bold">Legacy fallback</strong>
                <span class="text-sm text-gray-600 mt-1 block">Older versions are labeled and distinguishable</span>
              </div>
            </div>
            <div class="flex items-start gap-4">
              <div class="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <div>
                <strong class="block text-gray-900 font-bold">Official sources</strong>
                <span class="text-sm text-gray-600 mt-1 block">Every document links back to its original source</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <section id="database" class="py-20 md:py-28">
    <div class="container-page" data-animate="fade-up">
      <div class="max-w-3xl">
        <span class="section-label">Indexed Database</span>
        <h2 class="section-title mt-4">Available Sources</h2>
        <p class="section-desc">Browse our curated collection of Moroccan legal documents from verified official sources.</p>
      </div>
  ...
  <section class="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 py-20 md:py-28">
    ...
    <div class="relative z-10 container-page text-center" data-animate="fade-up">
      <h2 class="text-3xl md:text-5xl font-serif font-bold text-white leading-tight">Start Your Legal Research Today</h2>
      <p class="mt-4 text-lg md:text-xl text-blue-100 max-w-2xl mx-auto">Access thousands of Moroccan legal documents from a single, professional workspace.</p>
      <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
        <a href="/register" class="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-blue-700 bg-white hover:bg-blue-50 shadow-2xl shadow-blue-900/30 transition-all duration-200 no-underline">
          Create Free Account
