...
@section('content')
    ...
    <section
        ...
        <div class="relative z-10 container-page pt-20 md:pt-24 pb-16 md:pb-24">
            <div class="max-w-4xl">
                <span
                    class="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold tracking-wider uppercase bg-white/10 text-blue-200 border border-white/10 backdrop-blur-sm mb-8">
                ...
                <form
                    ...
                    <div class="flex items-center gap-3 flex-1 px-4">
                        <svg class="w-5 h-5 text-blue-300 flex-shrink-0" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
        ...
        <div class="container-page" data-animate="fade-up">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-12">
                <article class="card card-hover p-6 md:p-8" data-animate="fade-up" style="--delay: 0s">
                    <div
                        class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center mb-5 shadow-lg shadow-blue-500/20">
    ...
    <section id="coverage" class="py-20 md:py-28 bg-gradient-to-b from-gray-50 to-white">
        <div class="container-page">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="card p-6 md:p-8 border-blue-100 bg-gradient-to-br from-blue-50/50 to-white"
                    data-animate="fade-up" style="--delay: 0.15s">
                    <div class="space-y-5">
                        <div class="flex items-start gap-4">
                            <div
                                class="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center flex-shrink-0 mt-1">
