...
const initializeDatabase = async () => {
  ...
  try {
    ...
    await ensureIndex(
      connection,
      "laws",
      "idx_laws_document_title",
      "CREATE INDEX idx_laws_document_title ON laws (document_title)"
    );
    await ensureIndex(
      connection,
      "laws",
      "ft_laws_search",
      "CREATE FULLTEXT INDEX ft_laws_search ON laws (title, document_title, law_reference, content)"
    );
    await ensureIndex(
      connection,
      "law_translations",
